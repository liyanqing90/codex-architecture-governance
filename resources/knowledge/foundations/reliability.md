...
- interruptions
- retries
- or recovery affect critical flows.

## Avoid when

- Do not demand high availability without a declared impact or target.
...
- Makes failure behavior and recovery explicit.

## Costs and liabilities

- Redundancy and recovery controls add operational complexity.
