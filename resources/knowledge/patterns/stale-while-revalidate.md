---
id: pattern.stale-while-revalidate
kind: pattern
version: 1.0.0
status: active
domains:
...
Prioritize performance-efficiency, reliability while explicitly recording effects on reliability, security, performance, maintainability, delivery speed, cost, and cognitive load.
