...
2. Run `architecture_tool.py select-knowledge` with
   ...
   Profile. Persist the result as
   `.architecture/knowledge-selection-ai-agent.yaml`, then read every selected
   Markdown entry completely. Do not load unrelated packs.
